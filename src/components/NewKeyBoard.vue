<template>
    <div class="container">
        <div class="row">
            <div class="keyboard keyboard-w--6">
                <p>Esc</p>
            </div>
            <div class="keyboard">
                <p>F1</p>
        ...
        <div class="row">
            ...
            <div v-for="(value, key) in numbers" :key="key" :id="value.id" class="keyboard"
                :class="{ active: value.active, 'keyboard-key--0': key == 0 }" @click="handleClick(key)">{{ key }}</div>
            <div class="keyboard">
                <p>-</p>
            </div>
            <div class="keyboard">
            ...
            <div class="keyboard keyboard-w--8">
                <p>Backspace</p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="keyboard keyboard-w--10">
                <p>Shift</p>
            </div>
            <div class="keyboard">
                <p>Z</p>
        ...
        <div class="row">
            ...
            <div class="keyboard keyboard-w--24">
                <p>Space</p>
            </div>
            <div class="keyboard">
                <p>Alt</p>
            ...
            <div class="keyboard keyboard-h--1-up">
                <p>Up</p>
            </div>
            <div class="keyboard keyboard-h--1-left">
                <p>Left</p>
            </div>
            <div class="keyboard keyboard-h--1-down">
                <p>Down</p>
            </div>
            <div class="keyboard keyboard-h--1-right">
                <p>Right</p>
            </div>
        </div>
    </div>
...
function handleKeyUp(e) {
    ...
    //use pinia
    const todo = todoStore.findOneById(value)
...
<style lang="scss" scoped>@import '~/assets/scss/newkeyboard.scss'</style>